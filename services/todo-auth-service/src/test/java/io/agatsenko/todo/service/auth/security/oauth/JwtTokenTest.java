...
public class JwtTokenTest {
    ...
    private final JwtTokenParser tokenParser = new JjwtTokenParser(signingKeys);

    @Test
    public void createdTokenShouldMatchToParsedToken() {
        ...
        final var parsedToken = tokenParser.parse(srcToken.getTokenValue());
